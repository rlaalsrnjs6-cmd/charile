	...
	<div class="up-wrap">
		...
		<form method="post" action="update1.report" enctype="multipart/form-data">
			...
			<div class="up-row">
				...
				<input type="text" name="title" value="${dto.title }" class="up-in">
			</div>
			
			<div class="up-row">
				<span class="up-lb">내용</span> 
				<textarea name="content" class="up-in ta-lg">${dto.content}</textarea>
			</div>
			
			<div class="up-row">
				<span class="up-lb">첨부파일</span>
