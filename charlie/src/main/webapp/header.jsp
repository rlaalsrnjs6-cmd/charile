...
/* 		padding: 0% 1% ; */
	...
	.hd-nav a { color: #333; transition: color 0.2s; }
	.hd-nav a:hover { color: #5C6BC0; }
	...
	*/
	...
	@media (max-width: 768px) {
		.hd-bar { flex-direction: column; gap: 0.8rem; }
		.hd-nav { gap: 1rem; font-size: 0.9rem; }
		.mes-cont { padding-top: 7rem; }
	}
</style>
</head>
<body>
<% 
	...
	if(level == null) level = 9; // 비로그인 기본값
%>
