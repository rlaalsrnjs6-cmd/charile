	...
	<div class="log-wrap">
		...
		<form method="post" action="check" id="loginForm">
			...
			<div class="log-row">
				...
				<input type="text" name="id" class="log-in" placeholder="id를 입력하세요" value="wqer1234">
			</div>
			
			<div class="log-row">
				<span class="log-lb">비밀번호</span>
				<input type="password" name="pw" class="log-in" placeholder="pw를 입력하세요" value="Qwer1234@">
			</div>
