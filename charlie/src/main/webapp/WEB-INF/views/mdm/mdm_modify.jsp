	...
	<div id="mdm-mod-scope">
		<div class="mod-wrap">
			...
			<form id="modForm" method="post" action="mdm">
				...
				<div class="mod-row">
					<span class="mod-lb">관리번호</span>
					<span class="mod-txt">${ mdmDTO.mdm_num }</span>
				</div>

				<div class="mod-row">
					<span class="mod-lb">코드</span>
					<input type="text" name="code" value="${ mdmDTO.code }" class="mod-in">
				</div>

				<div class="mod-row">
					<span class="mod-lb">이름</span>
					<input type="text" name="name" value="${ mdmDTO.name }" class="mod-in">
				</div>

				<div class="mod-row">
					<span class="mod-lb">단위</span>
					<select name="unit" class="mod-in">
				...
				<div class="mod-row">
					<span class="mod-lb">수량</span>
					<input type="text" name="quantity" value="${ mdmDTO.quantity }" class="mod-in">
				</div>

				<div class="mod-row">
					<span class="mod-lb">타입</span>
					<select name="type" class="mod-in">
						<option value="assemble" ${mdmDTO.type == 'assemble' ? 'selected' : ''}>반제품</option>
						<option value="product" ${mdmDTO.type == 'product' ? 'selected' : ''}>제품</option>
						<option value="material" ${mdmDTO.type == 'material' ? 'selected' : ''}>재료</option>
						<option value="equip" ${mdmDTO.type == 'equip' ? 'selected' : ''}>장비</option>
				    </select>
				</div>
				  
				<div class="mod-row">
					<span class="mod-lb">가격</span>
					<input type="text" name="price" value="${ mdmDTO.price }" class="mod-in">
				</div>
				
				<div class="mod-row">
					<span class="mod-lb">입고날짜</span>
					<span class="mod-txt">${ mdmDTO.received_date }</span>
				</div>

				<div class="mod-row">
					<span class="mod-lb">사용기한</span>
					<span class="mod-txt">${ mdmDTO.exp_date }</span>
				</div>
				...
				<div class="mod-row">
					...
					<div class="mod-rd-grp">
						<label class="mod-rd-item">
							<input type="radio" name="can_use" value="Y" ${mdmDTO.can_use == 'Y' ? 'checked' : ''}> 가능
						</label>
						<label class="mod-rd-item">
							<input type="radio" name="can_use" value="N" ${mdmDTO.can_use == 'N' ? 'checked' : ''}> 불가능
						</label>
					</div>
				</div>
