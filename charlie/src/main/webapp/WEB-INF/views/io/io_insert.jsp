...
<div class="reg-wrap">
	<div class="reg-tit">자재입고 페이지</div>

	<form id="regForm" method="post" action="io">
		
		<div class="reg-row">
			<label class="reg-lb">자재명칭 </label>
		...
		<div class="reg-row">
			...
			<input type="number" name="quantity" class="reg-in" value="30">
		</div>
		...
		<div class="reg-row">
			...
			<select name="storage_sec" class="reg-in">
				<option value="RM-A01">RM-A01</option>
				<option value="RM-A02">RM-A02</option>
				<option value="RM-B04">RM-B04</option>
				<option value="RM-B03">RM-B03</option>
				<option value="RM-B02">RM-B02</option>
				<option value="RM-B01">RM-B01</option>
			</select>
		</div>

		<div class="btn-grp">
			<input type="hidden" name="cmd" value="insert">
			<a href="io?cmd=list" class="btn-can">등록취소</a>
