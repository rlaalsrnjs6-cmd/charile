...
<%-- 	<span>품목 코드</span><input type="text" value="${result[0].code}"><br> --%>
	...
	<div id="update">
	<form method="post" action="PMDetailUpdateServlet">
	<input type="hidden" name="prod_num" value="${result[0].prod_num }">
	<span>제목</span><input name="title" class="PMD-input" type="text" value="${result[0].title }" ><br>
<%-- 	<span>품목 명</span><input name="mdmName" class="PMD-input" type="text" value="${result[0].mdmName}" readonly><br> --%>
<%-- 	<span>품목 코드</span><input type="text" value="${result[0].code}"><br> --%>
	<span>목표 총량</span><input name="targetAll"  class="PMD-input"type="text" value="${result[0].target_quantity}" ><br>
