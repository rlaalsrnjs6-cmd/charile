...
public class PersonalHygieneService {
		Map select(PersonalHygieneDTO dto, CommonDTO pageing){
			PersonalHygieneDAO dao = new PersonalHygieneDAO();
			System.out.println("위생서비스 시작");

			pageing.setTableName("personal_hygiene");
	        ...
	        List<PersonalHygieneDTO> list = dao.select(dto, pageing);
